...
<p className="text-center font-bold text-[.9rem] text-blue-500 my-1"><Link href="#">Forgot password</Link></p>
        <input type="submit" className='w-[100%] cursor-pointer max-w-[550px] mt-4 bg-[rgb(22,119,255)] text-white font-bold py-3 rounded-lg mx-auto block' value="Login" />

        <h1 className="text-[.9rem] mt-3 text-center text-gray-500  font-bold">Don&apos;t have an account? <Link href="/" className="text-blue-500 font-bold">Signup</Link></h1>
